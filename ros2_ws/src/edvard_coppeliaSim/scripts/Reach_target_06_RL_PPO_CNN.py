...
wandb.config.episode_length = EPISODE_LENGTH

wandb.init(
    project = "Reach-target-Run:01",
...
for e in range(EPISODES):
    ...
    for i in range(EPISODE_LENGTH):
        ...
        state = next_state
        image = next_image
    agent.learn(states, actions, log_probs_old, rewards, masks, values, images)  # Add images parameter
