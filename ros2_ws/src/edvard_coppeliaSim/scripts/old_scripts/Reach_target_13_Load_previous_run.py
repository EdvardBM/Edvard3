'''
If the model was originally trained on a GPU and is now being loaded on a CPU (or vice versa), you might need to map the model to the appropriate device.
...
RUN_NAME = 'Run_01_continue'
LOAD_PREVIOUS_RUN = True
PREVIOUS_RUN_PATH = '/home/h/Edvard2/ros2_ws/src/coppeliasim_launch/scripts/Reach_target_Recordings/Run_01_continue/best_episode/best_model.pth'
